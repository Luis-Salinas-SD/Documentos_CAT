	...
	$query = "SELECT * from tbl_asignados where idfolio=$folio";
            ...
            if ($numfilas == 0) {
                ...
                $res = $dbh->query($sql1);
					...
					$sql = "select a.idreg as id, a.idfolio as folio, s.area as area, u.id_usuario as cve, u.nombre as sp, c.tarea as concep  from  tbl_asignados a, tbl_usuarios u, cat_areas s, cat_conceptos c
