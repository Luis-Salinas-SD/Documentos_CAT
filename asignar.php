    ...
    <h3 class="text-center">Servidores Públicos Asignados</h3>
    ...
    <form class="form-inline" role="search" id="buscar">
      ...
      <div class="col-12 text-center">
        <a data-bs-toggle="modal" href="#newModal" class="btn btn-primary m-1">Agregar</a>
      </div>
    </form>
          ...
          <div class="modal-body">
            <form role="form" method="post" id="agregar"> <!-- action="leerdatos.php" -->
              ...
              <div class="form-group">
                ...
                <select name="area" id="area" class="form-select" tabindex="8">
