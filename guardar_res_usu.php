...
$query1 = ("UPDATE tbl_resolucion SET tipodocref='$tipodoc', nodoc='$num_doc', fecha='$fechares', estatus= 0, nota='$nota' WHERE docref=$idfolio and sprecibe='$cvesp'");
$result = $conexion->query($query1);

if ($_FILES["archivo"]["error"] > 0) {
	echo '<script>sinArchivo()</script> ';
	//echo "<script>location.href='tabla_usu.php' </script>";
